...
def compute_matches(gt_boxes, gt_class_ids, gt_masks, class_id,
...
def compute_ap(gt_boxes, gt_class_ids, gt_masks, class_id,
               pred_boxes, pred_class_ids, pred_scores, pred_masks,
               iou_threshold=0.5):
    ...
    gt_match, pred_match, overlaps = compute_matches(
        gt_boxes, gt_class_ids, gt_masks, class_id,
        pred_boxes, pred_class_ids, pred_scores, pred_masks,
        iou_threshold)
